...
public class WebTables {
    ...
    public void setup() {
        ...
        chromeOptions.setHeadless(true);//to run browser without GUI. Makes browser invisible(also makes it faster)
    ...
    public void verifyRowCount(){
        ////tbody//tr - to get all rows form table body, excluding table header
    ...
    /**
     * to get soecific column, skip row index, and just provide td index
     */
    @Test
